...
# type systems
class BaseTypeSystem:
    def __init__(self):
        pass

class Regular(BaseTypeSystem):
    def __init__(self):
        super().__init__()
        self.variables = {}

class Dependent(BaseTypeSystem):
    def __init__(self):
        super().__init__()
        self.variables = {}

class QueryBased(BaseTypeSystem):
    def __init__(self):
        super().__init__()
        self.variables = {}
...
class TypeSystem(BaseTypeSystem):
    def __init__(self):
        super().__init__()
        self.r = Regular()
        self.d = Dependent()
        self.q = QueryBased()
        self.types = TYPES
        self.vr = self.r.variables
        self.vd = self.d.variables
        self.vq = self.q.variables
